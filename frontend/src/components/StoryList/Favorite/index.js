...
const STORY = {
  ...
  description:
    `<div>
      ...
      and the fox's <Word id={60d2eab0501c6f0015e40aac} word={implement} /> mouth watered as he <Word id={60d2ebf6501c6f0015e40aaf} word={prvent} /> gazed longingly at them.
    </div>`,
  picture:
